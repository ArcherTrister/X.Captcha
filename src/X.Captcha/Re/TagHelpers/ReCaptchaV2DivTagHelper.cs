...
[HtmlTargetElement("re-captcha-v2-div", TagStructure = TagStructure.WithoutEndTag)]
public class ReCaptchaV2DivTagHelper : TagHelper
{
    ...
    public ReCaptchaV2DivTagHelper(IOptionsSnapshot<CaptchaOptions> optionsAccessor)
    {
