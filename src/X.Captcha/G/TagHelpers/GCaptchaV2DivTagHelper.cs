...
[HtmlTargetElement("g-captcha-v2-div", TagStructure = TagStructure.WithoutEndTag)]
public class GCaptchaV2DivTagHelper : TagHelper
{
    ...
    public GCaptchaV2DivTagHelper(IOptionsSnapshot<CaptchaOptions> optionsAccessor)
    {
