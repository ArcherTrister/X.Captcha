...
[HtmlTargetElement("g-captcha-v3-script-js", TagStructure = TagStructure.WithoutEndTag)]
public class GCaptchaV3ScriptJsTagHelper : TagHelper
{
    ...
    public GCaptchaV3ScriptJsTagHelper(IOptionsSnapshot<CaptchaOptions> optionsAccessor)
    {
