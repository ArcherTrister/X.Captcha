...
public class GCaptchaV2ElementTagHelper : TagHelper
{
    private const string BadgeAttributeName = "g-captcha-v2-badge";
    private const string ThemeAttributeName = "g-captcha-v2-theme";
    private const string SizeAttributeName = "g-captcha-v2-size";
    private const string TabIndexAttributeName = "g-captcha-v2-tab-index";
    private const string CallbackAttributeName = "g-captcha-v2-callback";
    private const string ExpiredCallbackAttributeName = "g-captcha-v2-expired-callback";
    private const string ErrorCallbackAttributeName = "g-captcha-v2-error-callback";
    ...
    public GCaptchaV2ElementTagHelper(IOptionsSnapshot<CaptchaOptions> optionsAccessor)
    {
